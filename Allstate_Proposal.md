...
Using the provided dataset we will use various techniques to predict the claims severity. Claim severity is expressed as a cost, where a higher cost is a higher severity.
